...
<template>
  <div class=" flex flex-col h-screen gap-12">
    <div class=" lg:bg-[url('./static/LoginBg.png')] w-full lg:h-[110vh] lg:px-20 lg:py-52 lg:bg-cover lg:bg-center lg:bg-no-repeat flex lg:justify-between">
        ...
        <div class=" pt-40 pb-8 lg:py-20 px-5 lg:px-24 bg-white rounded-md h-max w-[100%] lg:w-max">
            ...
            <div class=" flex flex-col gap-4">
                <input type="text" class=" border-b-2 lg:border-2 p-1.5 pr-10 w-[105%] lg:w-[100%] lg:rounded-lg lg:border-black" placeholder="Email address" value="">
                <button @click="$router.push('/')" class=" bg-[#1877F2] self-end  text-white py-1.5 px-3.5 rounded-full lg:rounded-lg">Contuine</button>
            </div>
          ...
          <div class=" flex gap-2 flex-col">
            <button class=" lg:bg-[#1877F2] text-sm flex border-2 px-10 lg:border-0 rounded-2xl justify-center lg:justify-start lg:pl-3 self-center lg:text-white font-bold p-3 lg:text-base gap-2 w-[100%]"> <img class=" w-5 h-5 self-center" src="../static/Facebook_f_logo_(2019).svg" alt=""> <p class="">Contuine with Facebook</p></button>
            ...
            <button class=" lg:bg-black text-sm flex border-2 px-10 lg:border-0 rounded-2xl justify-center lg:justify-start lg:pl-3 self-center lg:text-white font-bold p-3 lg:text-base gap-2 w-[100%]"> <img class=" w-5 h-5 self-center hidden lg:flex" src="../static/whiteAppleicon.png" alt="">
