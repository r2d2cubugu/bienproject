    ...
    <div class="h-10 px-3 py-2.5 rounded-3xl border border-white justify-center items-center gap-[20px] flex">
        ...
        <p class="text-white text-lg font-normal ">26</p>
            ...
            <div class=" lg:ml-20 flex flex-col gap-6 lg:gap-10 ">
                ...
                <div>
                    ...
                    <p class=" text-xl">#Model #Graphicdesigner #Uxuıdesigner</p>
                </div>
            </div>
        ...
        <div class=" grid grid-cols-1 lg:grid-cols-3 gap-2 w-full mt-11 lg:mt-40">
            <div  v-for=" photos in userPostsStore.userPosts">
                <button @click="userPostsStore.isComponentPost='myPost';userPostsStore.selectedPost = photos.id" class=" w-[500px] conta">
                    <img class=" w-[400px] h-[400px]" :src=photos.photoLink>
                    <!-- <p>{{ photos.comments }}</p> -->
                </button>
         </div>
        </div>
